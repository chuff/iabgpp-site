...
export class UsCoV1GpcSegment extends AbstractLazilyEncodableSegment {
    ...
    // overriden
    getFieldNames() {
        return USCOV1_GPC_SEGMENT_FIELD_NAMES;
    }
    // overriden
    initializeFields() {
        let fields = new EncodableBitStringFields();
        fields.put(UsCoV1Field.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
        fields.put(UsCoV1Field.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
        fields.put(UsCoV1Field.GPC.toString(), new EncodableBoolean(false));
        return fields;
    }
    // overriden
