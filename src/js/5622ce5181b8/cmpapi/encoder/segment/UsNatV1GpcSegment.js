...
import { USNATV1_GPC_SEGMENT_FIELD_NAMES } from "../field/UsNatV1Field.js";
import { UsNatV1Field } from "../field/UsNatV1Field.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";
export class UsNatV1GpcSegment extends AbstractLazilyEncodableSegment {
    ...
    // overriden
    getFieldNames() {
        return USNATV1_GPC_SEGMENT_FIELD_NAMES;
    }
    // overriden
    initializeFields() {
        let fields = new EncodableBitStringFields();
        fields.put(UsNatV1Field.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
        fields.put(UsNatV1Field.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
        fields.put(UsNatV1Field.GPC.toString(), new EncodableBoolean(false));
        return fields;
    }
    // overriden
    ...
    decodeSegment(encodedString, fields) {
        ...
        try {
            ...
            throw new DecodingError("Unable to decode UsNatV1GpcSegment '" + encodedString + "'");
        }
    }
}
